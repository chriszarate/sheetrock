...
describe('Transport', () => {
  describe('constructor()', () => {
    it.each([
      ...
      expect(() => new Transport(url, false)).toThrow(
        'No key/gid in the provided URL'
      );
    });
    ...
    it('correctly parses a 2010 URL', () => {
      ...
      expect(new Transport(url, false).endpoint).toEqual(expected);
    });

    it('correctly parses a 2014 URL', () => {
      const url = 'https://docs.google.com/spreadsheets/d/123/edit#gid=5';
      const expected =
        'https://docs.google.com/spreadsheets/d/123/gviz/tq?gid=5';
    ...
    it('provides a default gid for a 2014 URL', () => {
      ...
      const expected =
        'https://docs.google.com/spreadsheets/d/123/gviz/tq?gid=0';
